...
export class NuUIComponent extends NuRect {
    ...
    postresize() {
        var style =
            this.elem.currentStyle || window.getComputedStyle(this.elem);
...
export class NuPanel extends NuUIComponent {
    ...
    constructor(config) {
        ...
        if (orientation === "horizontal") {
            this.layout = new NuRowContainer(
                this.getInnerWidth(),
                this.getInnerHeight(),
                scrollable,
            );
        } else if (orientation == "vertical") {
            this.layout = new NuColumnContainer(
                this.getInnerWidth(),
                this.getInnerHeight(),
                scrollable,
            );
...
export class NuFrame extends NuUIComponent {
    ...
    applyConfig() {
        ...
        this.setElemStyle(
            "border",
            `${this.getCfg("frameBorderWidth")}px solid black`,
        );
    ...
    overFrameContents(pt) {
        ...
        if (
            pt.x > bw &&
            pt.y > bw &&
            pt.x < this.getWidth() - bw &&
            pt.y < this.getHeight() - bw
        ) {
            return "N";
        } else {
            return null;
